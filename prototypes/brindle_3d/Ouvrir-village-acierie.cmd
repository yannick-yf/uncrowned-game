...
echo Godot introuvable. Ouvrir project.godot dans Godot puis scenes/map_plate.tscn puis I.
pause
exit /b 1
:run
start "Village acierie" "%GODOT%" --path "%~dp0." --script res://tools/review_ironworks_town.gd
